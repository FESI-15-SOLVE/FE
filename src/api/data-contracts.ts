...
export interface GetJoinedMeetingsParams {
  /**
...
export interface GetMyCreatedMeetingsParams {
  /**
...
export interface GetMeetingDetailParams {
  /** @example "dallaem" */
  teamId: string;
  /**
   * @min 0
...
export interface UpdateMeetingStatusParams {
  /** @example "dallaem" */
  teamId: string;
  /**
   * @min 0
...
export interface GetMeetingTypesParams {
  /** @example "dallaem" */
  teamId: string;
}
...
export interface GetCategoryReviewStatisticsParams {
  /** @example "dallaem" */
  teamId: string;
}
...
export interface GetMeetingReviewsParams {
  /**
   * 특정 사용자의 리뷰만 조회
   * @min 0
   * @exclusiveMin true
...
export interface GetFavoriteCountParams {
  /** @example "dallaem" */
  teamId: string;
}
...
export interface GetOgMetadataParams {
  /**
   * OG 메타데이터를 가져올 URL
   * @format uri
