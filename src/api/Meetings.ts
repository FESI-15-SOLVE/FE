...
> extends HttpClient<SecurityDataType> {
   ...
   */
  getJoinedMeetings = (
    { teamId, ...query }: GetJoinedMeetingsParams,
  ...
  getMyCreatedMeetings = (
    { teamId, ...query }: GetMyCreatedMeetingsParams,
    params: RequestParams = {},
  ) =>
   ...
   */
  getMeetingDetail = (
    { teamId, meetingId }: GetMeetingDetailParams,
    params: RequestParams = {},
  ) =>
    this.request<MeetingWithHost, ErrorResponse>({
   ...
   */
  updateMeeting = (
    { teamId, meetingId }: UpdateMeetingParams,
    data: UpdateMeeting,
    params: RequestParams = {},
  ) =>
    this.request<MeetingWithHost, ErrorResponse>({
 ...
 */
  deleteMeeting = (
    { teamId, meetingId }: DeleteMeetingParams,
    params: RequestParams = {},
  ) =>
    this.request<
      {
 ...
 */
  joinMeeting = (
    { teamId, meetingId }: JoinMeetingParams,
    params: RequestParams = {},
  ) =>
    this.request<
      {
 ...
 */
  leaveMeeting = (
    { teamId, meetingId }: LeaveMeetingParams,
    params: RequestParams = {},
  ) =>
    this.request<
      {
   ...
   */
  getParticipants = (
    { teamId, meetingId, ...query }: GetParticipantsParams,
    params: RequestParams = {},
  ) =>
   ...
   */
  updateMeetingStatus = (
    { teamId, meetingId }: UpdateMeetingStatusParams,
