...
> extends HttpClient<SecurityDataType> {
   ...
   */
  getMyProfile = ({ teamId }: GetMyProfileParams, params: RequestParams = {}) =>
   ...
   */
  getUserProfile = (
    { teamId, userId }: GetUserProfileParams,
    params: RequestParams = {},
  ) =>
   ...
   */
  getMyMeetings = (
    { teamId, ...query }: GetMyMeetingsParams,
    params: RequestParams = {},
  ) =>
   ...
   */
  getMyReviews = (
    { teamId, ...query }: GetMyReviewsParams,
    params: RequestParams = {},
  ) =>
