...
> extends HttpClient<SecurityDataType> {
   ...
   */
  getPostDetail = (
    { teamId, postId }: GetPostDetailParams,
    params: RequestParams = {},
  ) =>
   ...
   */
  updatePost = (
    { teamId, postId }: UpdatePostParams,
    data: UpdatePost,
    params: RequestParams = {},
  ) =>
    this.request<PostWithAuthor, ErrorResponse>({
 ...
 */
  deletePost = (
    { teamId, postId }: DeletePostParams,
    params: RequestParams = {},
  ) =>
    this.request<
      {
   ...
   */
  createComment = (
    { teamId, postId }: CreateCommentParams,
    data: CreateComment,
    params: RequestParams = {},
  ) =>
   ...
   */
  getComments = (
    { teamId, postId, ...query }: GetCommentsParams,
    params: RequestParams = {},
  ) =>
   ...
   */
  likeComment = (
    { teamId, postId, commentId }: LikeCommentParams,
    params: RequestParams = {},
  ) =>
 ...
 */
  unlikeComment = (
    { teamId, postId, commentId }: UnlikeCommentParams,
    params: RequestParams = {},
  ) =>
    this.request<
      {
 ...
 */
  deleteComment = (
    { teamId, postId, commentId }: DeleteCommentParams,
    params: RequestParams = {},
  ) =>
    this.request<
      {
   ...
   */
  updateComment = (
    { teamId, postId, commentId }: UpdateCommentParams,
    data: UpdateComment,
    params: RequestParams = {},
  ) =>
    this.request<Comment, ErrorResponse>({
   ...
   * @response `409` `ErrorResponse` 이미 좋아요함
   */
  likePost = ({ teamId, postId }: LikePostParams, params: RequestParams = {}) =>
 ...
 */
  unlikePost = (
    { teamId, postId }: UnlikePostParams,
    params: RequestParams = {},
  ) =>
    this.request<
      {
