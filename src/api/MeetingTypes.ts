...
import {
  CreateMeetingType,
  CreateMeetingTypeParams,
  DeleteMeetingTypeParams,
  ErrorResponse,
  GetMeetingTypesParams,
  MeetingType,
  MeetingTypeList,
  UpdateMeetingType,
...
> extends HttpClient<SecurityDataType> {
   ...
   */
  createMeetingType = (
    { teamId }: CreateMeetingTypeParams,
   ...
   */
  updateMeetingType = (
    { teamId, typeId }: UpdateMeetingTypeParams,
 ...
 */
  deleteMeetingType = (
    { teamId, typeId }: DeleteMeetingTypeParams,
    params: RequestParams = {},
  ) =>
    this.request<
      {
