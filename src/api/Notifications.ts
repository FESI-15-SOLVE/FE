...
> extends HttpClient<SecurityDataType> {
   ...
   */
  getNotifications = (
    { teamId, ...query }: GetNotificationsParams,
 ...
 */
  deleteAllNotifications = (
    { teamId }: DeleteAllNotificationsParams,
    params: RequestParams = {},
  ) =>
    this.request<
      {
 ...
 */
  getUnreadNotificationCount = (
    { teamId }: GetUnreadNotificationCountParams,
    params: RequestParams = {},
  ) =>
    this.request<
      {
 ...
 */
  markAllNotificationsAsRead = (
    { teamId }: MarkAllNotificationsAsReadParams,
    params: RequestParams = {},
  ) =>
    this.request<
      {
  ...
  markNotificationAsRead = (
    { teamId, notificationId }: MarkNotificationAsReadParams,
    params: RequestParams = {},
  ) =>
 ...
 */
  deleteNotification = (
    { teamId, notificationId }: DeleteNotificationParams,
    params: RequestParams = {},
  ) =>
    this.request<
      {
