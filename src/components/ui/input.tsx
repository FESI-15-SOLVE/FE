  ...
  return (
    <InputPrimitive
      ...
      className={cn(
        ...
        "aria-invalid:border-error-500 disabled:bg-input/50 focus-visible:border-green-500 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50",
