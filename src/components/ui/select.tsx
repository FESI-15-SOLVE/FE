...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-1.5 rounded-md py-1 pr-1.5 pl-1.5 text-sm outline-hidden select-none focus:bg-slate-100 focus:text-slate-800 not-data-[variant=destructive]:focus:**:text-slate-800 data-disabled:pointer-events-none data-disabled:opacity-50 data-[selected]:bg-green-200 data-[selected]:text-slate-800 not-data-[variant=destructive]:data-[selected]:**:text-slate-800 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className,
      )}
      {...props}
    >
